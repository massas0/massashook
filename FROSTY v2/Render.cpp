...
void Render::SetupFonts()
{
	...
	font.Event = g_Surface->FontCreate();




	g_Surface->SetFontGlyphSet(font.ESP, "Calibri", 12, 400, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Event, "Calibri", 14, 700, 0, 1, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.Defuse, "Tahoma", 15, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.ESPMini, "Calibri", 10, 400, 0, 0, FONTFLAG_DROPSHADOW);
	...
	g_Surface->SetFontGlyphSet(font.Icon, "icomoon", 18, 800, 0, 0, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
